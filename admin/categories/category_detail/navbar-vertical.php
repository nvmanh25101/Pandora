...
<div class="main">
        ...
        <div class="navbar__content">
            <a class="navbar-brand px-5 d-block" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="navbar-brand__img" version="1.1"
                    ...
                    <polygon
                            points="177.9,10.2 179,10.2 179.1,10.2 178.1,0.1 178,0 177.7,0 177.7,0.1 176.6,10.2 176.7,10.2 "/>
                    <polygon
                            points="183.6,10.9 183.6,10.8 185.3,1.8 185.3,1.7 185,1.6 184.9,1.7 181.2,10.3 181.2,10.3 "/>
                    ...
                    <polygon
                            points="172.2,10.9 174.5,10.3 174.6,10.3 170.8,1.7 170.7,1.6 170.5,1.7 170.4,1.8 172.1,10.8 "/>
            ...
            <ul class="nav navbar__list flex-column">
                <li class="nav-item navbar__item">
                    <a class="nav-link d-flex align-items-center navbar__link <?= $page == 'root' ? 'active' : '' ?>"
                       href="../../root">
                ...
                <li class="nav-item navbar__item">
                    <a class="nav-link d-flex align-items-center navbar__link <?= $page == 'orders' ? 'active' : '' ?>"
                       href="../../orders">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action text-decoration-none"
                                   href="../../products/form_insert.php">Thêm Trang sức</a>
                            </li>
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action text-decoration-none"
                                   href="../../products?search_status=1">Đang bán</a>
                            </li>
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action text-decoration-none"
                                   href="../../products?search_status=0">Ngừng bán</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar__item">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action text-decoration-none"
                                   href="../../categories">Loại chính</a>
                            </li>
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action text-decoration-none <?= $page == 'category-detail' ? 'active' : '' ?> "
                                   href="../../categories/category_detail">Loại phụ</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar__item">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            ...
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action <?= $page == 'account-user' ? 'active' : '' ?>" href="../../accounts/users">Khách
                                    hàng</a>
                            </li>
                        </ul>
                    </div>
            ...
            <li class="nav-item navbar__item">
                ...
                <div class="sub-navbar">
                    <ul class="list-group">
                        ...
                        <li class="sub-navbar__item">
                            <a class="sub-navbar__link list-group-item-action text-decoration-none <?= $page == 'category-detail' ? 'active' : '' ?>" href="../../categories/category_detail">Loại
                                phụ</a>
                        </li>
                    </ul>
                </div>
    ...
    <header class="header d-flex justify-content-between align-items-center">
        ...
        <form action="" class="form__search hide-on-mobile-tablet">
            <input type="search" name="search" class="input__search" value="<?php $search ?? '' ?>"
