	...
	<div class="container pt-3">
        <div class="row">
            <div class="col-md mt-2">
                <h1 class="text-footer">Giới thiệu</h1>
                <ul class="list-unstyled">
                    <li><a href="">Về Pandora</a></li>
                    <li><a href="">Câu chuyện Pandora</a></li>
                    <li><a href="">Về Tập Đoàn Norbreeze</a></li>
                    <li><a href="">Liên hệ</a></li>
                </ul>
            </div>
            <div class="col-md mt-2">
                <h1 class="text-footer">Khám phá Pandora</h1>
                <ul class="list-unstyled">
            ...
            <div class="col-md mt-2">
                <h1 class="text-footer">Điều khoản và dịch vụ</h1>
                <ul class="list-unstyled">
            ...
            <div class="col-md mt-2">
                <h1 class="text-footer">Hệ thống cửa hàng</h1>
                <ul class="list-unstyled">
                    <li><a href="">Hồ Chí Minh</a></li>
                    <li><a href="">Hà Nội</a></li>
                    <li><a href="">Hệ thống Pandora toàn quốc</a></li>
                </ul>
            </div>
            <div class="col-md mt-2">
                <h1 class="text-footer">Giao hàng</h1>
                <ul class="list-unstyled">
                <li><a href="">VNPost</a></li>
                    <li><a href="">Nhất tín Logistics</a></li>
                </ul>
            </div>
        </div>
    </div>
