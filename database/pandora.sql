...
--
-- Host: localhost:3306
-- Generation Time: Apr 18, 2023 at 12:26 PM
...
INSERT INTO `votes` (`id`, `product_id`, `user_id`, `rating`, `created_at`) VALUES
...
--
ALTER TABLE `carts`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã của giỏ hàng', AUTO_INCREMENT=27;
...
--
ALTER TABLE `category_child`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã loại phụ', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã đơn hàng', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã sản phẩm', AUTO_INCREMENT=43;
...
--
ALTER TABLE `users`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã người dùng', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `votes`
--
ALTER TABLE `votes`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'mã đánh giá', AUTO_INCREMENT=3;
