<?php 
    ...
    $sql = "select products.*, category_child.name as category_name, users.name as admin_name, products.user_id, sizes.name AS name_size
    from products
    join category_child
