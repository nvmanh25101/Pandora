            ...
            <ul class="nav navbar__list flex-column">
                ...
                <li class="nav-item navbar__item">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            ...
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action" href="../products?search_status=0">Ngừng
                                    bán</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item navbar__item">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action" href="../categories">Loại chính</a>
                            </li>
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action" href="../categories/category_detail">Loại
                                    phụ</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item navbar__item">
                    ...
                    <div class="sub-navbar">
                        <ul class="list-group">
                            ...
                            <li class="sub-navbar__item">
                                <a class="sub-navbar__link list-group-item-action" href="../categories/category_detail">Khách
                                    hàng</a>
                            </li>
                        </ul>
                    </div>
